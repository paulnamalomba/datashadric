...
- [datashadric — Module Reference Notes](#datashadric--module-reference-notes)
  ...
  - [`imputation.py` — Multiple Imputation Methods *(new in v0.3.0)*](#imputationpy--multiple-imputation-methods-new-in-v030)
...
## `imputation.py` — Multiple Imputation Methods *(new in v0.3.0)*
