# PowerShell script to create .commits/ directory and files

# Create .commits directory
New-Item -ItemType Directory -Force -Path ".commits" | Out-Null

# Create v0.1.3-alpha.txt
$textContent = @"
Ecoride v0.1.3-alpha Release Notes
...
Set-Content -Path ".commits\v0.1.0-alpha.txt" -Value $textContent -Encoding UTF8
...
Set-Content -Path ".commits\v0.1.3-alpha.json" -Value $jsonContent -Encoding UTF8

Write-Host "✅ Created .commits\v0.1.3-alpha.txt" -ForegroundColor Green
Write-Host "✅ Created .commits\v0.1.3-alpha.json" -ForegroundColor Green
Write-Host ""
Write-Host "Files created successfully in .commits\ directory" -ForegroundColor Cyan
